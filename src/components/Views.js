...
function DayView(props) {
    const articles = Object.keys(props.articles).sort(
...
function MonthView(props) {
    const days = Object.keys(props.contents_m).sort(
        (a, b) => parseInt(a) - parseInt(b)
    )
            ...
            >
                <tbody>
                    <tr>
                        ...
                        <td>
                            改淸州牧爲西原縣. 以
                            <span style={{ color: 'red' }}>劇賊</span>
                            胎生邑, <span style={{ color: 'blue' }}>降號</span>
                            也.
                        </td>
                    </tr>
                    <tr>
                        <th style={{ textAlign: 'center' }}>
                            {' '}
                            Original <br /> Korean Translations <br /> (gt-oKo){' '}
                        </th>
                        <td>
                            청주목을 서원현으로 고쳤다.{' '}
                            <span style={{ color: 'red' }}>극적</span>이 태생한
                            고을은 <span style={{ color: 'blue' }}>강호</span>
                            하기 때문이다. <br />
                            <br />
                            Eng.) Cheongju-mok was renamed Seowon-hyeon. It is
                            because the town gets{' '}
                            <span style={{ color: 'blue' }}>gangho</span>
                            if <span style={{ color: 'red' }}>geukjeok</span> is
                            born.
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            청주목을 서원현으로 고쳤다.{' '}
                            <span style={{ color: 'red' }}>극악한 역적</span>
                            이 태어난 고을이므로 읍호를 강등한 것이다. <br />
                            <br />
                            Eng.) Cheongju-mok was renamed Seowon-hyeon. Since
                            it is a town where{' '}
                            <span style={{ color: 'red' }}>
                                a vicious traitor
                            </span>{' '}
                            was born, the town was{' '}
                            <span style={{ color: 'blue' }}>demoted</span>.
                        </td>
                    </tr>
                </tbody>
            </Table>
...
export function YearView(props) {
    ...
    return (
        <div style={styles.marinContainerStyle}>
            <h3>
                {props.king_name} - Year {props.year_n}
            </h3>
